  ...
  return (
    <>
      <section className="w-full pb-10 pt-20 px-6 max-w-7xl mx-auto lg:flex-row flex-col flex gap-10">
        <div className="w-80 px-6 pb-6 pt-20 flex flex-col justify-center items-center bg-rose-500 border-[5px] border-black shadow-100 rounded-[30px] relative z-0 h-fit max-lg:w-full">
